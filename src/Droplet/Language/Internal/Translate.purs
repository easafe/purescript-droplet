...
instance
      ...
      Translate (Drop (Table name fields)) where
      translate _ = do
            pure $ dropKeyword
                  <> tableKeyword
                  <> quote (Proxy ∷ _ name)
