...
-- | Constraint refers to field declaration
data SameField

-- | Constraint name should be generated by the system
data Unnamed

-- | Column does not have constraints
data NoConstraints
...
data ForeignKey ∷ ∀ k. k → Type → Type
data ForeignKey fields table

type Constraint (t ∷ Type) = ConstraintDefinition Unnamed SameField t

type NamedConstraint (name ∷ Symbol) (t ∷ Type) = ConstraintDefinition name SameField t

type SharedConstraint (name ∷ Symbol) (t ∷ Type) (fields ∷ Type) = ConstraintDefinition name fields t

data ConstraintDefinition ∷ ∀ n f t. n → f → t → Type
data ConstraintDefinition name fields t

type Column t constraint = ColumnDefinition t SameName constraint

type RenamedColumn (t ∷ Type) (name ∷ Symbol) = ColumnDefinition t name NoConstraints

data ColumnDefinition ∷ ∀ k. Type → k → Type → Type
data ColumnDefinition t name constraint
...
instance UnwrapDefinition (ColumnDefinition t n c) t
