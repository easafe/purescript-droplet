...
type Constraint (t ∷ Type) = ConstraintDefinition Unnamed ThisField t

type NamedConstraint (name ∷ Symbol) (t ∷ Type) = ConstraintDefinition name ThisField t

type SharedConstraint (name ∷ Symbol) (t ∷ Type) (fields ∷ Type) = ConstraintDefinition name fields t

data ConstraintDefinition ∷ ∀ n. n → Type → Type → Type
...
instance FieldCannotBeSet constraints ⇒ FieldCannotBeSet (Column t constraints)

else instance Fail (Text "Identity columns cannot be inserted or updated") => FieldCannotBeSet Identity

else instance (FieldCannotBeSet some, FieldCannotBeSet more) ⇒ FieldCannotBeSet (some /\ more)
