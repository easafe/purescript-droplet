...
markAsRun ∷ ∀ r. Connection → { identifier ∷ String | r } → Aff Unit
...
execute ∷ ∀ parameters list. RowToList parameters list ⇒ ToParameters parameters list ⇒ Connection → String → Record parameters → Aff Unit
